Scheduleme.classes.views.ScheduleListView = Backbone.View.extend({
	...
	addOneSchedule: function (schedule) {
		...
		if (schedule.get('type') == 'month') {
			...
			this.$('#dates').append('<li class="schedule-tab"><a href="#", data-transition="slide", data-id="'+schedule.id+'" class="schedule-link">'+datestring+'</a></li>');
			...
			this.$('#dates').append('<li class="schedule-tab"><a href="#", data-transition="slide", data-id="'+schedule.id+'" class="schedule-link">'+datestring+'<sup>'+Sups[d.getDate()%10]+'</sup> - '+(Scheduleme.meta.mobile ? '' : '<br/>')+ndatestring+'<sup>'+Sups[nd.getDate()%10]+'</sup></a></li>');
			...
			this.$('#dates').append('<li class="schedule-tab"><a href="#", data-transition="slide", data-id="'+schedule.id+'" class="schedule-link">'+datestring+'<sup>'+Sups[d.getDate()%10]+'</sup></a></li>');
