...
module.exports = queries = {
  ...
  'selectById'      : 'SELECT user_id AS id, name, contact_email, contact_phone, img, UNIX_TIMESTAMP(creation_time) as creation_time, UNIX_TIMESTAMP(modified_time) as modified_time FROM employers WHERE employer_id=? LIMIT 1'
