...
module.exports = queries = {
	...
	'getSchedulesByEmployer'	: 'SELECT schedule_id as id, json, date, type, image_loc AS url FROM schedules WHERE employer_id=? AND awaitingupload = false AND published = true',
	'getSchedulesByEmployerFuture'	: 'SELECT schedule_id as id, json, date, type, image_loc AS url FROM schedules WHERE employer_id=? AND date>=? AND awaitingupload = false AND published = true',
