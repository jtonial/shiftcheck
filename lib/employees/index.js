...
app.get('/',        [ permissionCheck('employee') ], Controller.getEmployees );
app.post('/',       [ permissionCheck('employee') ], Controller.addEmployee );
app.delete('/:id',  [ permissionCheck('employee') ], Controller.deleteEmployee );
