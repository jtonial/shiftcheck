module.exports = queries = {
  ...
  'selectById'              : 'SELECT * FROM employees WHERE employee_id=? LIMIT 1',
  'selectEmployees'         : 'SELECT employee_id as id, first_name, last_name, username, email FROM employees WHERE employer_id=? AND active=1', 
