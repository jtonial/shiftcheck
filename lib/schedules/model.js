...
var Schedule = {
  ...
  save : function (cb) {
    ...
    if (typeof this.id == 'undefined') { //Create
      ...
      db.query(Main.Queries.getScheduleByEmployerDate, [_this.data.employer_id, dateFormatted], function (err, row) {
...
exports.verifyUpload = function (id, cb) {
  db.query(Main.Queries.verifyUpload,[id], function (err, result) {
    var obj = {
      err   : err,
      result   : result
    }
...
exports.getByEmployer = function (obj, cb) {
  ...
  db.query(Main.Queries.getSchedulesByEmployerFuture, [id, (new Date()).toISOString()], function (err, rows) {
...
exports.getByEmployerDate = function (obj, cb) {
  ...
  db.query(Main.Queries.getScheduleByEmployerDate, [id,date], function (err, row) {
...
exports.getById = function (obj, cb) {
  ...
  db.query(Queries.getScheduleById, [employer_id, schedule_id], function (err, row) {
...
exports.publish = function (obj, cb) {
  ...
  db.query(Main.Queries.publishSchedule, [schedule_id, employer_id], function (err, result) {
    var response = {};
...
exports.unpublish = function (obj, cb) {
  ...
  db.query(Main.Queries.unpublishSchedule, [schedule_id, employer_id], function (err, result) {
    var response = {};
