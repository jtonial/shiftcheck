...
app.post('/:schedule_id/publish',   [ permissionCheck ], Controller.publish );
app.post('/:schedule_id/unpublish', [ permissionCheck ], Controller.unpublish );
app.post('/verifyUpload',           [ permissionCheck ], Controller.verifyUpload );

app.put('/:schedule_id',    [ permissionCheck ], Controller.update);
