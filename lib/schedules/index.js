...
app.post('/:schedule_id/shifts/:shift_id',      [ permissionCheck('shift') ], Controller.addShift );
app.put('/:schedule_id/shifts/:shift_id',       [ permissionCheck('shift') ], Controller.updateShift );
app.delete('/:schedule_id/shifts/:shift_id',    [ permissionCheck('shift') ], Controller.deleteShift );
