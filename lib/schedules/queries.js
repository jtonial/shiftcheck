module.exports = queries = {
  ...
  'getScheduleById'         : 'SELECT schedule_id as id, json, date, type, image_loc AS url FROM schedules WHERE employer_id=? AND schedule_id=? AND awaitingupload = false AND published = true LIMIT 1',
