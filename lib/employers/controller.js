...
exports.addEmployee = function (req, res) {
  ...
  Main.Models.Employee.create(obj, function (err, result) {
    var response = {};
    if (err) {
      response.statusCode = 500;
...
exports.deleteEmployee = function (req, res) {
  ...
  Main.Models.Employee.deactivate(obj, function (err, result) {
    var response = {};
    if (err) {
      response.statusCode = 500;
      response.message = err.code;
...
exports.getEmployees = function (req, res) {
  ...
  Main.Models.Employee.getByEmployer (obj, function (err, response) {
    Main.Render.code(req.xhr, res, response);
  })
};
