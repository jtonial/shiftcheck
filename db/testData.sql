...
INSERT INTO schedules (`schedule_id`, `employer_id`, `date`, `type`, `creation_time`, `image_loc`)
	VALUES	(1, 1, '2013-01-20', 'day', NOW(), '12BarzTickets.pdf'),
			(2, 1, '2013-01-21', 'day', NOW(), '12BarzTickets.pdf'),
			(3, 1, '2013-01-22', 'day', NOW(), '12BarzTickets.pdf'),
			(4, 1, '2013-01-23', 'week', NOW(), '12BarzTickets.pdf');